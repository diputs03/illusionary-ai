...
namespace illusion.Kernel.IPK_Adapter
{
    ...
    internal static class IPK_BaseMethods
    {
        ...
        private static extern IntPtr IPK_GetErrorMessageNative(IPK_RESULT errorCode);

        [DllImport(DllName, EntryPoint = "IPK_FreeString", CallingConvention = CallingConvention.Cdecl)]
        internal static extern void IPK_FreeString(IntPtr str);

        internal static string GetErrorMessage(IPK_RESULT errorCode)
        {
            IntPtr ptr = IPK_GetErrorMessageNative(errorCode);
        ...
        internal static extern IPK_RESULT IPK_CreateListAST(Size_t length, IntPtr[] elements, out IntPtr out_ast);
        ...
        internal static extern IPK_RESULT IPK_GetSymbolAST(IntPtr ast, out IntPtr out_name);

        [DllImport(DllName, EntryPoint = "IPK_AST_GetList", CallingConvention = CallingConvention.Cdecl)]
        internal static extern IPK_RESULT IPK_GetListAST(IntPtr ast, Size_t index, out IntPtr out_elements);
        ...
        internal static extern IPK_RESULT IPK_ToStringAST(IntPtr ast, out IntPtr str);
        #endregion

        #region IPK_Parser
        [DllImport(DllName, EntryPoint = "IPK_ParseStatement", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        internal static extern IPK_RESULT IPK_ParseStatement(string line, out IntPtr out_ast);
        #endregion

        #region IPK_Context
        [DllImport(DllName, EntryPoint = "IPK_Context_Create", CallingConvention = CallingConvention.Cdecl)]
        internal static extern IPK_RESULT IPK_CreateContext(out IntPtr out_context);
